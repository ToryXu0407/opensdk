...
import com.nascent.ecrp.opensdk.openplatformrequest.coupon.GetCancelCouponListRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.coupon.GetCancelCouponListResponse;

import java.io.IOException;

public class GetCancelCouponListTest {
    public static void main(String [] args) throws IOException, ApiException {
        GetCancelCouponListRequest request = new GetCancelCouponListRequest();
    ...
    private static void getResponse(GetCancelCouponListRequest request, DefaultOpenPlatformClient defaultPointClient) {
        try {
            GetCancelCouponListResponse response = defaultPointClient.execute(request);
