...
import com.nascent.ecrp.opensdk.openplatformrequest.coupon.SendOneCouponRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.coupon.SendOneCouponResponse;

import java.io.IOException;

public class SendOneCouponTest {
    public static void main(String [] args) throws IOException, ApiException {
        SendOneCouponRequest request = new SendOneCouponRequest();
    ...
    private static void getResponse(SendOneCouponRequest request, DefaultOpenPlatformClient defaultPointClient) {
        try {
            SendOneCouponResponse response = defaultPointClient.execute(request);
