...
import com.nascent.ecrp.opensdk.openplatformrequest.coupon.GetCouponInfoListRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.coupon.GetCouponInfoListResponse;

import java.io.IOException;

public class GetCouponInfoListTest {
    public static void main(String [] args) throws IOException, ApiException {
        GetCouponInfoListRequest request = new GetCouponInfoListRequest();
    ...
    private static void getResponse(GetCouponInfoListRequest request, DefaultOpenPlatformClient defaultPointClient) {
        try {
            GetCouponInfoListResponse response = defaultPointClient.execute(request);
