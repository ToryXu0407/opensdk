...
import com.nascent.ecrp.opensdk.openplatformrequest.customer.SaveCustomerRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.customer.SaveCustomerResponse;
...
public class SaveCustomerTest {
    public static void main(String [] args) throws IOException, ApiException {
        ...
        //设置其他需要的参数
        request.setNick("lk15280238625dsa");
        request.setNickType(1);
        request.setOutAlias("hell2o");
        request.setPlatSubMemberMark("adsdsas");
    ...
    private static void getResponse(SaveCustomerRequest request, DefaultOpenPlatformClient defaultPointClient) {
        try {
            SaveCustomerResponse response = defaultPointClient.execute(request);
