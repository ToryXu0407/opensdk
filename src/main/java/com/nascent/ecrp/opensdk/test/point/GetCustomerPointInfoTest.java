...
import com.nascent.ecrp.opensdk.openplatformrequest.point.GetCustomerPointInfoRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.point.GetCustomerPointInfoResponse;

import java.io.IOException;

public class GetCustomerPointInfoTest {

    public static void main(String [] args) throws IOException, ApiException {

        GetCustomerPointInfoRequest request = new GetCustomerPointInfoRequest();
...
//        request.setCustomerId(2329428000313667L);
    ...
    private static void getResponse(GetCustomerPointInfoRequest request, DefaultOpenPlatformClient defaultOpenPlatformClient) {
        try {
            GetCustomerPointInfoResponse response = defaultOpenPlatformClient.execute(request);
