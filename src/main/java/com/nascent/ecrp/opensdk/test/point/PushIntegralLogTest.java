...
import com.nascent.ecrp.opensdk.openplatformrequest.point.PushIntegralLogRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.point.PushIntegralLogResponse;

import java.io.IOException;

public class PushIntegralLogTest {

    public static void main(String [] args) throws IOException, ApiException {

        PushIntegralLogRequest request = new PushIntegralLogRequest();
...
//        request.setCustomerId(2329428000313667L);
        request.setLog("PushIntegralLogResponse");
    ...
    private static void getResponse(PushIntegralLogRequest request, DefaultOpenPlatformClient defaultOpenPlatformClient) {
        try {
            PushIntegralLogResponse response = defaultOpenPlatformClient.execute(request);
