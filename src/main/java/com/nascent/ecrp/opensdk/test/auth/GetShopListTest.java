...
import com.nascent.ecrp.opensdk.openplatformrequest.auth.GetShopListRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.auth.GetShopListResponse;
...
public class GetShopListTest {
    ...
    private static void getResponse(GetShopListRequest request, DefaultOpenPlatformClient defaultOpenPlatformClient) {
        try {
            ...
            System.out.println(response.getResult().get(0).getShopId());
