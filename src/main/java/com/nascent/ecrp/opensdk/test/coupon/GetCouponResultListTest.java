...
import com.nascent.ecrp.opensdk.openplatformrequest.coupon.GetCouponResultListRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.coupon.GetCouponResultListResponse;

import java.io.IOException;

public class GetCouponResultListTest {
    public static void main(String [] args) throws IOException, ApiException {
        GetCouponResultListRequest request = new GetCouponResultListRequest();
    ...
    private static void getResponse(GetCouponResultListRequest request, DefaultOpenPlatformClient defaultPointClient) {
        try {
            GetCouponResultListResponse response = defaultPointClient.execute(request);
