...
import com.nascent.ecrp.opensdk.openplatformrequest.property.GetCustomerInfoWithPropertyRequest;
import com.nascent.ecrp.opensdk.openplatformresponse.property.GetCustomerInfoWithPropertyResponse;

import java.io.IOException;

public class GetCustomerInfoWithPropertyTest {
    public static void main(String [] args) throws IOException, ApiException {
        GetCustomerInfoWithPropertyRequest request = new GetCustomerInfoWithPropertyRequest();
    ...
    private static void getResponse(GetCustomerInfoWithPropertyRequest request, DefaultOpenPlatformClient defaultPointClient) {
        try {
            GetCustomerInfoWithPropertyResponse response = defaultPointClient.execute(request);
